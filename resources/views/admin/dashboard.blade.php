                    ...
                    <div class="d-flex align-items-end row">
                        ...
                        <div class="col-md-6 text-center text-md-end order-1 order-md-2">
                            <div class="card-body pb-0 px-0 px-md-4 ps-0">
                                <img src="{{asset('tadmin/assets/img/illustrations/illustration-john-light.png')}}" height="180"
                                    alt="View Profile" 
                                    />
                            </div>
                        </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="card-info mt-4 pt-1 mt-lg-1 mt-xl-4">
                            ...
                            <p class="mb-lg-2 mb-xl-3">Total Pasien Online</p>
            ...
            <div class="col-lg-2 col-sm-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="card-info mt-4 pt-1 mt-lg-1 mt-xl-4">
                            <h5 class="mb-2">155k</h5>
                            <p class="mb-lg-2 mb-xl-3">Total Pasien Offline</p>
                            <div class="badge bg-label-secondary rounded-pill">Hari Ini</div>
                        </div>
                    </div>
                </div>
