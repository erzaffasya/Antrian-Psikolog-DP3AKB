                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="post" action="{{ route('spesialis.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="basic-icon-default-fullname"
                                            placeholder="Masukan Dokter" name="spesialis"
                                            aria-label="Masukan Dokter"
                                            aria-describedby="basic-icon-default-fullname2" />
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 form-label" for="basic-icon-default-message">Batas Maksimal Antrian</label>
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 form-label" for="basic-icon-default-message">Apakah Hari Ini Libut?</label>
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-message2" class="input-group-text">
                                            <i class="mdi mdi-message-outline"></i>
