<x-app-layout>
            ...
            <div class="card-datatable table-responsive pt-0">
                <div class="container-fluid my-5 d-flex">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card">
                                    <div class="card-body bg-success text-white">
                                        ...
                                        <p class="fw-bold text-white my-2 text-center display-1">
                                            {{ $AntrianForDokter['current']->urut }}</p>
                                    </div>
                                </div>
                            </div>
                        @else
                    ...
                    @if (isset($AntrianForDokter['current']) != null)
                        <div class="row col-4">
                            <div class="col d-grid gap-2" style="margin-left: 10%;">
                                ...
                                <button type="button" class="btn btn-warning mb-2" data-bs-toggle="modal"
                                    data-bs-target="#profilePasienModal">
                                    <i class="fa fa-user me-2"></i>
                                    Profil Pasien
                                </button>

                                <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal"
                                    data-bs-target="#nextQueueModal">
    ...
    <!-- Modal Profile User -->
    @if (isset($User))
        <div class="modal fade" id="profilePasienModal" tabindex="-1" aria-labelledby="profilePasienModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <div class="modal fade" id="antrianSelesaiModal" tabindex="-1" aria-labelledby="antrianSelesaiModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
        ...
        document.getElementById('nextQueueModalButton').addEventListener('click', function() {
            ...
            fetch('/update-status', {
                ...
                .then(data => {
                    ...
                    if (data.data != null) {
                        window.open(
                            `https://wa.me/62${data.data.telepon}?text=Bisa masuk nomor antrian ${data.data.nomor} atas nama ${data.data.nama}`,
                            '_blank'
                        );
                    }
